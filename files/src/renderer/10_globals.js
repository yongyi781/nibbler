...
const openingbox = document.getElementById("openingname");
...
const forced_lc0_options = {
	// These are sent without checking if they are known by the engine, so it doesn't matter
...
const standard_lc0_options = {
	// These are only sent if known by the engine.
...
const limit_options = [
	1, 2, 5, 10, 20, 50, 100, 125, 160, 200, 250, 320, 400, 500, 640, 800, 1000,
	1250, 1600, 2000, 2500, 3200, 4000, 5000, 6400, 8000, 10000, 12500, 16000,
	20000, 25000, 32000, 40000, 50000, 64000, 80000, 100000, 125000, 160000,
	200000, 250000, 320000, 400000, 500000, 640000, 800000, 1000000, 1250000,
	1600000, 2000000, 2500000, 3200000, 4000000, 5000000, 6400000, 8000000,
	10000000, 12500000, 16000000, 20000000, 25000000, 32000000, 40000000,
	50000000, 64000000, 80000000, 100000000, 125000000, 160000000, 200000000,
	250000000, 320000000, 400000000, 500000000, 640000000, 800000000,
	1000000000,
];
